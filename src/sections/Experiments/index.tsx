    ...
    <section className="work" id="experiments">
      ...
      <div className="work-container container-spacing">
        ...
        <div className="feature-box">
          ...
          <p className="feature-box__text">
            new yorker is a web application developed with new york times behind
            the scenes to search through its content, see top stories, look for
            categories, with some cool charts.
          </p>
          <a
        ...
        <div className="feature-box">
          ...
          <p className="feature-box__text">
            shopify is an e-commerce mobile app. built with react native at its
            core, you can make up your profile, shop through categories,
